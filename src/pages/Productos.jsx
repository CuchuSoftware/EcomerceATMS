...
export default function Productos() {
  ...
  const [paginaActual, setPaginaActual] = useState(1);
    ...
    useEffect(() => {
    document.title = "Tienda de Cajeros Automaticos | Productos";
    ...
    // Meta tags básicos
    updateMetaTag('description',  'Explora el catálogo de productos para cajeros automáticos. Dispensadores, recicladores y aceptadores de billetes.');
    updateMetaTag('keywords',  'ATM, cajeros automáticos, cash dispenser, cash recycler, bill acceptor, depósito inteligente, dispensador, reciclador, desposito');
    updateMetaTag('author', '@webmaster');
    updateMetaTag('robots', 'index, follow');
    
    // Open Graph
    updateMetaTag('og:title', 'Productos para Cajeros Automáticos', 'property');
    updateMetaTag('og:description',  'Explora el catálogo de productos para cajeros automáticos.',  'property');
